...
# Smoke test: Run tasks with average@2 (Offline RAG version)
# Quick validation to ensure the offline RAG pipeline works correctly
...
RESULTS_DIR="../../logs/smoke_test_offline/${TIMESTAMP}_${BENCHMARK_NAME}_${NUM_TASKS}tasks_average_at_${NUM_RUNS}"

echo "=========================================="
echo "SMOKE TEST (Offline RAG) - average@${NUM_RUNS}"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "SMOKE TEST RESULTS (Offline RAG)"
echo "=========================================="
